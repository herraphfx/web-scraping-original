...
st.set_page_config(page_title="Henry's Web Scraper", page_icon="🕵️‍♂️")
st.title("Henry Web Scraper 🕵️‍♂️")
...
st.html( """ <style> [data-testid="stSidebarContent"] { color: white; background-color: #6AB5E2; } </style> """ )
...
# Main action button
if st.sidebar.button("SCRAPE ME!", type="primary"):
    if url_input.strip() == "":
